...
},{"./Player":7,"./ui":30}],7:[function(require,module,exports){
'use strict';
...
},{"./Brain":3,"./PomDPSimulator":9,"./prematureOptimization":27}],9:[function(require,module,exports){
'use strict';
...
},{"./prematureOptimization":27}],10:[function(require,module,exports){
'use strict';
...
},{"./game_sendCard":21,"./layout":23}],12:[function(require,module,exports){
'use strict';
...
},{"./layout":23}],14:[function(require,module,exports){
'use strict';
...
},{"./Card":4,"./layout":23}],15:[function(require,module,exports){
"use strict";
...
function toName(number) {
    if (typeof number === 'number') return NTS[number];else return number;
}

function toNum(name) {
    if (typeof name === 'string') return STN[name];else return name;
}
...
exports.default = {
    ...
    getPlayers: function getPlayers(array) {
        ...
        array.forEach(function (player) {
            ...
            if (player.location === toName(location)) me = player;else others.push(player);
        });
...
function socketConnect() {
    ...
    socket = (0, _socket_io2.default)(pageURL.host + (':' + serverPort + '/' + nameSpace), {
        reconnection: true,
...
},{"./Debug":5,"./config":15,"./game_core":20,"./loadingPage":24,"./loginPage":25,"./socket_io":29,"./ui":30}],17:[function(require,module,exports){
'use strict';
...
},{"./Ai":1,"./AsyncBrain":2,"./Human":6,"./PomDPBrain":8,"./RandomBrain":10,"./SimpleBrain":12,"./board":14,"./config":15,"./domBinding":17,"./rules":28,"./ui":30}],20:[function(require,module,exports){
'use strict';
...
var game_start = function game_start(mess) {
    ...
    if (location === 'bottom') _config2.default.setNames([players.me.name, players.others[0].name, players.others[1].name, players.others[2].name]);
    if (location === 'left') _config2.default.setNames([players.me.name, players.others[1].name, players.others[2].name, players.others[0].name]);
    if (location === 'right') _config2.default.setNames([players.me.name, players.others[0].name, players.others[1].name, players.others[2].name]);
    if (location === 'top') _config2.default.setNames([players.me.name, players.others[2].name, players.others[0].name, players.others[1].name]);
    (0, _main2.default)();
};
...
var teamScore = function teamScore(mess) {
    function getOurTeam(loc) {
        if (loc === 'top' || loc === 'bottom') return { our: "topB", their: "rightL" };else if (loc === 'right' || loc === 'left') return { our: "rightL", their: "topB" };
    }
...
},{"./config":15,"./game":19,"./loadingPage":24,"./main":26,"./ui":30}],21:[function(require,module,exports){
'use strict';
...
},{"./config":15}],22:[function(require,module,exports){
'use strict';
...
},{"./connectToServer":16,"./fixPageResponsive":18}],23:[function(require,module,exports){
"use strict";
...
},{"./config":15,"./loadingPage":24,"./ui":30}],26:[function(require,module,exports){
'use strict';
...
},{"./config":15,"./domBinding":17,"./game":19,"./layout":23}],27:[function(require,module,exports){
"use strict";
...
},{"buffer":32}],30:[function(require,module,exports){
'use strict';
